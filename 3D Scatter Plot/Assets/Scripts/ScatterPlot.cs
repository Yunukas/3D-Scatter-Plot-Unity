...
public class ScatterPlot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // get the pointList from the DataStore
        pointList = DataStore.GetPointList();
        // process the point list with a coroutine
		StartCoroutine("ProcessPointList");
    }
    
    // this method will create all the game objects
    private void createPoints(List<Dictionary<string, object>> list)
	{
